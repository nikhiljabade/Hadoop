...
public class TextPairDriver extends Configured implements Tool{
    ...
    public int run(String[] args) throws Exception {
        Path inputPath = new Path("./src/main/java/com/cloudwick/hadoop/assignment/textpaircount/TextPairInput/textpairinput.txt");
        Path outputPath = new Path("./src/main/java/com/cloudwick/hadoop/assignment/textpaircount/TextPairOutput");
